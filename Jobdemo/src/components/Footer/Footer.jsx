            ...
            <div className="flex items-center space-x-4">
              ...
              >
                <svg
                  ...
                  viewBox="0 0 24 24"
                >
                  <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.618 5.367 11.986 11.988 11.986s11.987-5.368 11.987-11.986C24.004 5.367 18.635.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.611-3.197-1.559l1.665-1.177c.417.532 1.043.884 1.762.884.719 0 1.346-.352 1.763-.884l1.665 1.177c-.749.948-1.9 1.559-3.197 1.559h-.461zm7.424 0c-1.297 0-2.448-.611-3.197-1.559l1.665-1.177c.417.532 1.043.884 1.762.884s1.346-.352 1.763-.884l1.665 1.177c-.749.948-1.9 1.559-3.197 1.559h-.461z" />
                </svg>
              </a>
