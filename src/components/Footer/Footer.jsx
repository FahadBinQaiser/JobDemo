...
const Footer = () => {
  return (
    <>
      <footer className="hidden border-t border-[#1C1C1C] sm:flex bg-[#1C1C1C] text-white py-16 px-10">
      ...
      <footer className="flex sm:hidden bg-[#1C1C1C] text-white py-6 px-10">
        <div className="w-full flex flex-col space-y-2">
          <div className="flex items-center space-x-2">
            <div className="w-10 h-10 flex items-center justify-center">
              <img src="/logo/Logomark.png" alt="Logo" />
            </div>
            <span className="text-white text-3xl font-medium">CirriNote</span>
          </div>

          <div className="flex items-center pb-10 pt-4 space-x-6">
            <a
              href="#"
              className="text-white hover:text-green-500 transition-colors"
            >
          ...
          <div className="flex flex-col space-y-1">
            <p className="text-[#8C8C8C] text-sm">© CirriNote 2025</p>
