    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-4 md:hidden">
          <div className="flex relative items-center cursor-pointer bg-white text-black rounded-full w-[130px] z-50 transition duration-150 hover:scale-110 pr-2 gap-4 overflow-hidden group">
